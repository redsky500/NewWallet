...
const Security = (props) => {
    ...
    return (
        <BgView>
            <Header.Back title="Security" onBackPress={props.navigation.goBack} containerStyle={styles.header} />
            <View style={styles.container}>
                <View style={styles.top}>
                    ...
                    <Paragraph style={styles.label}>Enable Biometric Security</Paragraph>
                    <Picker
                        // mode="dropdown"
                    ...
                    <Paragraph style={styles.label}>App lock</Paragraph>
                    <Picker
                        // mode="dropdown"
                        backgroundColor={theme.headerbackground}
                        style={{
