...
const NativeCoin = (props) => {
    ...
    return (
        <BgView>
            <Header.Back title="Add Asset" onBackPress={props.navigation.goBack} containerStyle={styles.header} />
            <View style={styles.container}>
                <View style={styles.top}>
                    <View style={{ paddingVertical: width * 0.02 }} />
                    <Paragraph style={styles.label}>Choose asset</Paragraph>
                    <Picker
                        // mode="dropdown"
                ...
                <View style={styles.bottom}>
                    <Button
                        ...
                        onPress={() => props.navigation.navitate('home')}
                    />
                </View>
            </View>
        </BgView>
